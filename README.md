...
* **[Biopython](https://github.com/biopython/biopython) ⭐ 5,192 | 🐛 614 | 🌐 Python | 📅 2026-09-04** - Freely available tools for biological computing in Python, with included cookbook, packaging and thorough documentation. Part of the [Open Bioinformatics Foundation](http://open-bio.org/). Contains the very useful [Entrez](https://biopython.org/DIST/docs/api/Bio.Entrez-module.html) package for API access to the NCBI databases. \[ [paper-2009](https://pubmed.ncbi.nlm.nih.gov/19304878) | [web](https://biopython.org) ]
...
* **[Nextflow](https://github.com/nextflow-io/nextflow) ⭐ 3,481 | 🐛 431 | 🌐 Groovy | 📅 2026-09-10 (recommended)** - A fluent DSL modelled around the UNIX pipe concept, that simplifies writing parallel and scalable pipelines in a portable manner. \[ [paper-2018](https://pubmed.ncbi.nlm.nih.gov/29412134) | [web](http://nextflow.io) ]
...
* **[MultiQC](https://github.com/ewels/MultiQC) ⭐ 1,492 | 🐛 264 | 🌐 JavaScript | 📅 2026-09-09** - Aggregate results from bioinformatics analyses across many samples into a single report. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/27312411) | [web](http://multiqc.info) ]
...
* **[Hail](https://github.com/hail-is/hail) ⭐ 1,071 | 🐛 362 | 🌐 Python | 📅 2026-09-10** - Scalable genomic analysis.
...
* **[Bowtie 2](https://github.com/BenLangmead/bowtie2) ⭐ 811 | 🐛 192 | 🌐 C++ | 📅 2026-09-10** - An ultrafast and memory-efficient tool for aligning sequencing reads to long reference sequences. \[ [paper-2012](https://pubmed.ncbi.nlm.nih.gov/22388286) | [web](http://bowtie-bio.sourceforge.net/bowtie2) ]
...
* **[MMseqs2](https://github.com/soedinglab/MMseqs2) ⭐ 2,139 | 🐛 287 | 🌐 C | 📅 2026-09-08** - Ultra-fast, sensitive search and clustering suite for protein and nucleotide sequence sets. \[ [paper-2017](https://www.nature.com/articles/nbt.3988) | [paper-2018](https://www.nature.com/articles/s41467-018-04964-5) ]
...
* **[Scanpy](https://github.com/scverse/scanpy) ⭐ 2,559 | 🐛 535 | 🌐 Python | 📅 2026-09-10** - Scalable toolkit for analyzing single-cell gene expression data, including preprocessing, visualization, clustering, and trajectory inference. \[ [paper-2018](https://doi.org/10.1186/s13059-017-1382-0) | [web](https://scanpy.readthedocs.io) ]
* **[pysam](https://github.com/pysam-developers/pysam) ⭐ 911 | 🐛 265 | 🌐 Cython | 📅 2026-09-07** - Python wrapper for [samtools](https://github.com/samtools/samtools) ⭐ 1,951 | 🐛 204 | 🌐 C | 📅 2026-09-10. \[ [web](https://pysam.readthedocs.io/en/latest/api.html) ]
...
* **[Bakta](https://github.com/oschwengers/bakta) ⭐ 677 | 🐛 28 | 🌐 Python | 📅 2026-08-07** - Bakta is a tool for the rapid & standardized annotation of bacterial genomes & plasmids. It provides dbxref-rich and sORF-including annotations in machine-readable JSON & bioinformatics standard file formats for automatic downstream analysis.
...
* **[IGV js](https://github.com/igvteam/igv) ⭐ 758 | 🐛 198 | 🌐 Java | 📅 2026-09-10** - Java-based browser. Fast, efficient, scalable visualization tool for genomics data and annotations. Handles a large variety of formats. \[ [paper-2019](https://pubmed.ncbi.nlm.nih.gov/31099383) | [web](https://software.broadinstitute.org/software/igv) ]
