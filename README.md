...
* **[Biopython](https://github.com/biopython/biopython) ⭐ 5,200 | 🐛 614 | 🌐 Python | 📅 2026-09-21** - Freely available tools for biological computing in Python, with included cookbook, packaging and thorough documentation. Part of the [Open Bioinformatics Foundation](http://open-bio.org/). Contains the very useful [Entrez](https://biopython.org/DIST/docs/api/Bio.Entrez-module.html) package for API access to the NCBI databases. \[ [paper-2009](https://pubmed.ncbi.nlm.nih.gov/19304878) | [web](https://biopython.org) ]

* **[Rust-Bio](https://github.com/rust-bio/rust-bio) ⭐ 1,839 | 🐛 103 | 🌐 Rust | 📅 2026-09-21** - Rust implementations of algorithms and data structures useful for bioinformatics. \[ [paper-2016](http://bioinformatics.oxfordjournals.org/content/early/2015/10/06/bioinformatics.btv573.short?rss=1) ]
...
* **[Biojava](https://github.com/biojava/biojava) ⭐ 632 | 🐛 68 | 🌐 Java | 📅 2026-09-19** - Java framework for processing biological data.

* **[SeqAn](https://github.com/seqan/seqan3) ⭐ 463 | 🐛 34 | 🌐 C++ | 📅 2026-09-21** - The modern C++ library for sequence analysis.
...
* **[CSVKit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 44 | 🌐 Python | 📅 2026-09-17** - Utilities for working with CSV/Tab-delimited files. \[ [web](https://csvkit.readthedocs.io/en/latest) ]
...
* **[csvtk](https://github.com/shenwei356/csvtk) ⭐ 1,170 | 🐛 1 | 🌐 Go | 📅 2026-09-21** - Another cross-platform, efficient, practical and pretty CSV/TSV toolkit. \[ [web](https://bioinf.shenwei.me/csvtk) ]
...
* **[Nextflow](https://github.com/nextflow-io/nextflow) ⭐ 3,490 | 🐛 414 | 🌐 Groovy | 📅 2026-09-21 (recommended)** - A fluent DSL modelled around the UNIX pipe concept, that simplifies writing parallel and scalable pipelines in a portable manner. \[ [paper-2018](https://pubmed.ncbi.nlm.nih.gov/29412134) | [web](http://nextflow.io) ]
...
* **[redun](https://github.com/insitro/redun) ⭐ 602 | 🐛 34 | 🌐 Python | 📅 2026-07-17** - A python-based workflow manager.
...
* **[Awesome-Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,627 | 🐛 32 | 📅 2026-09-21** - A list of pipeline resources.
...
* **[Bactopia](https://github.com/bactopia/bactopia/) ⭐ 522 | 🐛 66 | 🌐 Nextflow | 📅 2026-08-05** - A flexible pipeline, built with Nextflow, for the complete analysis of bacterial genomes. \[ [web](https://bactopia.github.io/) ]
...
* **[SeqKit](https://github.com/shenwei356/seqkit) ⭐ 1,593 | 🐛 8 | 🌐 Go | 📅 2026-09-21** - A cross-platform and ultrafast toolkit for FASTA/Q file manipulation in Golang. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/27706213) | [web](https://bioinf.shenwei.me/seqkit) ]
* **[Seqtk](https://github.com/lh3/seqtk) ⭐ 1,562 | 🐛 69 | 🌐 C | 📅 2025-06-01** - Toolkit for processing sequences in FASTA/Q formats.
* **[MultiQC](https://github.com/ewels/MultiQC) ⭐ 1,492 | 🐛 282 | 🌐 JavaScript | 📅 2026-09-15** - Aggregate results from bioinformatics analyses across many samples into a single report. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/27312411) | [web](http://multiqc.info) ]
...
* **[SeqFu](https://github.com/telatin/seqfu2) ⭐ 131 | 🐛 0 | 🌐 Nim | 📅 2026-09-19** - Sequence manipulation toolkit for FASTA/FASTQ files written in Nim. \[ [paper-2021](https://www.mdpi.com/2306-5354/8/5/59) | [web](https://telatin.github.io/seqfu2/) ]
...
* **[Hail](https://github.com/hail-is/hail) ⭐ 1,073 | 🐛 369 | 🌐 Python | 📅 2026-09-21** - Scalable genomic analysis.
...
* **[BWA](https://github.com/lh3/bwa) ⭐ 1,768 | 🐛 100 | 🌐 C | 📅 2026-08-07** - Burrow-Wheeler Aligner for pairwise alignment between DNA sequences.
* **[DIAMOND](https://github.com/bbuchfink/diamond) ⭐ 1,322 | 🐛 221 | 🌐 C++ | 📅 2026-09-21** - An ultrafast protein aligner for `blastp` and `blastx` like searches. \[ [paper-2021](https://www.nature.com/articles/s41592-021-01101-x) ]
* **[Bowtie 2](https://github.com/BenLangmead/bowtie2) ⭐ 812 | 🐛 190 | 🌐 C++ | 📅 2026-09-15** - An ultrafast and memory-efficient tool for aligning sequencing reads to long reference sequences. \[ [paper-2012](https://pubmed.ncbi.nlm.nih.gov/22388286) | [web](http://bowtie-bio.sourceforge.net/bowtie2) ]
...
* **[WFA](https://github.com/smarco/WFA) ⭐ 228 | 🐛 26 | 🌐 C | 📅 2026-08-07** - the wavefront alignment algorithm (WFA) which expoit sequence similarity to speed up alignment \[ [paper-2020](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btaa777/5904262) ]
...
* **[MMseqs2](https://github.com/soedinglab/MMseqs2) ⭐ 2,146 | 🐛 287 | 🌐 C | 📅 2026-09-13** - Ultra-fast, sensitive search and clustering suite for protein and nucleotide sequence sets. \[ [paper-2017](https://www.nature.com/articles/nbt.3988) | [paper-2018](https://www.nature.com/articles/s41467-018-04964-5) ]
...
* **[DeepVariant](https://github.com/google/deepvariant) ⭐ 3,810 | 🐛 2 | 🌐 Python | 📅 2026-03-19** - Deep learning-based variant caller \[ [paper-2018](https://rdcu.be/7Dhl) ]
* **[bcftools](https://github.com/samtools/bcftools) ⭐ 894 | 🐛 345 | 🌐 C | 📅 2026-09-21** - samtools/bcftools are a suite of tools for manipulating NGS data and can be used to call variants. \[ [paper-2009](https://pubmed.ncbi.nlm.nih.gov/19505943) | [web](http://htslib.org) ]
* **[freebayes](https://github.com/ekg/freebayes) ⭐ 879 | 🐛 48 | 🌐 C++ | 📅 2026-09-03** - Bayesian haplotype-based polymorphism discovery and genotyping. \[ [web](http://arxiv.org/abs/1207.3907) ]
...
* **[Delly](https://github.com/dellytools/delly) ⭐ 537 | 🐛 38 | 🌐 C++ | 📅 2026-09-21** - Structural variant discovery by integrated paired-end and split-read analysis. \[ [paper-2012](https://pubmed.ncbi.nlm.nih.gov/22962449) ]
...
* **[bcftools](https://github.com/samtools/bcftools) ⭐ 894 | 🐛 345 | 🌐 C | 📅 2026-09-21** - Set of tools for manipulating VCF files. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/26826718) | [paper-2017](https://pubmed.ncbi.nlm.nih.gov/28205675) | [web](http://samtools.github.io/bcftools) ]
...
* **[Bedtools2](https://github.com/arq5x/bedtools2) ⭐ 1,050 | 🐛 287 | 🌐 C | 📅 2026-06-10** - A Swiss Army knife for genome arithmetic. \[ [paper-2010](https://pubmed.ncbi.nlm.nih.gov/20110278) | [paper-2014](https://pubmed.ncbi.nlm.nih.gov/25199790) | [web](https://bedtools.readthedocs.io) ]
...
* **[pyensembl](https://github.com/openvax/pyensembl) ⭐ 408 | 🐛 11 | 🌐 Python | 📅 2026-09-16** - Pythonic Access to the Ensembl database. \[ [web](https://pyensembl.readthedocs.io/en/latest/pyensembl.html) ]
...
* **[Scanpy](https://github.com/scverse/scanpy) ⭐ 2,563 | 🐛 538 | 🌐 Python | 📅 2026-09-21** - Scalable toolkit for analyzing single-cell gene expression data, including preprocessing, visualization, clustering, and trajectory inference. \[ [paper-2018](https://doi.org/10.1186/s13059-017-1382-0) | [web](https://scanpy.readthedocs.io) ]
* **[pysam](https://github.com/pysam-developers/pysam) ⭐ 910 | 🐛 265 | 🌐 Cython | 📅 2026-09-07** - Python wrapper for [samtools](https://github.com/samtools/samtools) ⭐ 1,959 | 🐛 206 | 🌐 C | 📅 2026-09-10. \[ [web](https://pysam.readthedocs.io/en/latest/api.html) ]
...
* **[polars-bio](https://github.com/biodatageeks/polars-bio) ⭐ 200 | 🐛 46 | 🌐 Python | 📅 2026-09-21** - Python library for blazing-fast genomic interval operations and genomic file formats I/O on Polars DataFrames \[ [paper-2025](https://doi.org/10.1093/bioinformatics/btaf640) | \[ [web](https://biodatageeks.org/polars-bio/) ] ]
...
* **[Bakta](https://github.com/oschwengers/bakta) ⭐ 681 | 🐛 27 | 🌐 Python | 📅 2026-08-07** - Bakta is a tool for the rapid & standardized annotation of bacterial genomes & plasmids. It provides dbxref-rich and sORF-including annotations in machine-readable JSON & bioinformatics standard file formats for automatic downstream analysis.

## Long-read sequencing

### Long-read Assembly

* **[flye](https://github.com/fenderglass/Flye) ⭐ 950 | 🐛 25 | 🌐 C | 📅 2026-04-03** - De novo assembler for single molecule sequencing reads using repeat graphs.
...
* **[IGV js](https://github.com/igvteam/igv) ⭐ 763 | 🐛 148 | 🌐 Java | 📅 2026-09-21** - Java-based browser. Fast, efficient, scalable visualization tool for genomics data and annotations. Handles a large variety of formats. \[ [paper-2019](https://pubmed.ncbi.nlm.nih.gov/31099383) | [web](https://software.broadinstitute.org/software/igv) ]
