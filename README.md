...
* **[CSVKit](https://github.com/wireservice/csvkit) ⭐ 6,408 | 🐛 44 | 🌐 Python | 📅 2026-08-03** - Utilities for working with CSV/Tab-delimited files. \[ [web](https://csvkit.readthedocs.io/en/latest) ]
...
* **[Nextflow](https://github.com/nextflow-io/nextflow) ⭐ 3,487 | 🐛 410 | 🌐 Groovy | 📅 2026-09-17 (recommended)** - A fluent DSL modelled around the UNIX pipe concept, that simplifies writing parallel and scalable pipelines in a portable manner. \[ [paper-2018](https://pubmed.ncbi.nlm.nih.gov/29412134) | [web](http://nextflow.io) ]
...
* **[Bactopia](https://github.com/bactopia/bactopia/) ⭐ 522 | 🐛 65 | 🌐 Nextflow | 📅 2026-08-05** - A flexible pipeline, built with Nextflow, for the complete analysis of bacterial genomes. \[ [web](https://bactopia.github.io/) ]
...
* **[SeqKit](https://github.com/shenwei356/seqkit) ⭐ 1,593 | 🐛 20 | 🌐 Go | 📅 2026-09-17** - A cross-platform and ultrafast toolkit for FASTA/Q file manipulation in Golang. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/27706213) | [web](https://bioinf.shenwei.me/seqkit) ]
* **[Seqtk](https://github.com/lh3/seqtk) ⭐ 1,561 | 🐛 69 | 🌐 C | 📅 2025-06-01** - Toolkit for processing sequences in FASTA/Q formats.
* **[MultiQC](https://github.com/ewels/MultiQC) ⭐ 1,492 | 🐛 274 | 🌐 JavaScript | 📅 2026-09-15** - Aggregate results from bioinformatics analyses across many samples into a single report. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/27312411) | [web](http://multiqc.info) ]
...
* **[Hail](https://github.com/hail-is/hail) ⭐ 1,072 | 🐛 369 | 🌐 Python | 📅 2026-09-16** - Scalable genomic analysis.
...
* **[BWA](https://github.com/lh3/bwa) ⭐ 1,765 | 🐛 100 | 🌐 C | 📅 2026-08-07** - Burrow-Wheeler Aligner for pairwise alignment between DNA sequences.
* **[DIAMOND](https://github.com/bbuchfink/diamond) ⭐ 1,321 | 🐛 216 | 🌐 C++ | 📅 2026-09-14** - An ultrafast protein aligner for `blastp` and `blastx` like searches. \[ [paper-2021](https://www.nature.com/articles/s41592-021-01101-x) ]
...
* **[MMseqs2](https://github.com/soedinglab/MMseqs2) ⭐ 2,144 | 🐛 287 | 🌐 C | 📅 2026-09-13** - Ultra-fast, sensitive search and clustering suite for protein and nucleotide sequence sets. \[ [paper-2017](https://www.nature.com/articles/nbt.3988) | [paper-2018](https://www.nature.com/articles/s41467-018-04964-5) ]
...
* **[Delly](https://github.com/dellytools/delly) ⭐ 535 | 🐛 38 | 🌐 C++ | 📅 2026-09-17** - Structural variant discovery by integrated paired-end and split-read analysis. \[ [paper-2012](https://pubmed.ncbi.nlm.nih.gov/22962449) ]
...
* **[mosdepth](https://github.com/brentp/mosdepth) ⭐ 877 | 🐛 49 | 🌐 Nim | 📅 2026-05-02** - fast BAM/CRAM depth calculation for WGS, exome, or targeted sequencing. \[ [paper-2017](https://pubmed.ncbi.nlm.nih.gov/29096012/) ]
...
* **[wgsim](https://github.com/lh3/wgsim) ⭐ 289 | 🐛 21 | 🌐 C | 📅 2021-09-03** - **Comes with samtools!** - Reads simulator. \[ [web](https://popmodels.cancercontrol.cancer.gov/gsr/packages/wgsim) ]
...
* **[pyensembl](https://github.com/openvax/pyensembl) ⭐ 407 | 🐛 10 | 🌐 Python | 📅 2026-09-16** - Pythonic Access to the Ensembl database. \[ [web](https://pyensembl.readthedocs.io/en/latest/pyensembl.html) ]
...
* **[Scanpy](https://github.com/scverse/scanpy) ⭐ 2,561 | 🐛 539 | 🌐 Python | 📅 2026-09-17** - Scalable toolkit for analyzing single-cell gene expression data, including preprocessing, visualization, clustering, and trajectory inference. \[ [paper-2018](https://doi.org/10.1186/s13059-017-1382-0) | [web](https://scanpy.readthedocs.io) ]
...
* **[IGV js](https://github.com/igvteam/igv) ⭐ 759 | 🐛 148 | 🌐 Java | 📅 2026-09-17** - Java-based browser. Fast, efficient, scalable visualization tool for genomics data and annotations. Handles a large variety of formats. \[ [paper-2019](https://pubmed.ncbi.nlm.nih.gov/31099383) | [web](https://software.broadinstitute.org/software/igv) ]
