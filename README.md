...
* **[Biopython](https://github.com/biopython/biopython) ⭐ 5,206 | 🐛 613 | 🌐 Python | 📅 2026-09-22** - Freely available tools for biological computing in Python, with included cookbook, packaging and thorough documentation. Part of the [Open Bioinformatics Foundation](http://open-bio.org/). Contains the very useful [Entrez](https://biopython.org/DIST/docs/api/Bio.Entrez-module.html) package for API access to the NCBI databases. \[ [paper-2009](https://pubmed.ncbi.nlm.nih.gov/19304878) | [web](https://biopython.org) ]
...
* **[CSVKit](https://github.com/wireservice/csvkit) ⭐ 6,411 | 🐛 44 | 🌐 Python | 📅 2026-09-21** - Utilities for working with CSV/Tab-delimited files. \[ [web](https://csvkit.readthedocs.io/en/latest) ]
...
* **[Nextflow](https://github.com/nextflow-io/nextflow) ⭐ 3,492 | 🐛 422 | 🌐 Groovy | 📅 2026-09-24 (recommended)** - A fluent DSL modelled around the UNIX pipe concept, that simplifies writing parallel and scalable pipelines in a portable manner. \[ [paper-2018](https://pubmed.ncbi.nlm.nih.gov/29412134) | [web](http://nextflow.io) ]
...
* **[Awesome-Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,628 | 🐛 33 | 📅 2026-09-21** - A list of pipeline resources.
...
* **[Bactopia](https://github.com/bactopia/bactopia/) ⭐ 523 | 🐛 68 | 🌐 Nextflow | 📅 2026-08-05** - A flexible pipeline, built with Nextflow, for the complete analysis of bacterial genomes. \[ [web](https://bactopia.github.io/) ]
...
* **[MultiQC](https://github.com/ewels/MultiQC) ⭐ 1,492 | 🐛 279 | 🌐 JavaScript | 📅 2026-09-24** - Aggregate results from bioinformatics analyses across many samples into a single report. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/27312411) | [web](http://multiqc.info) ]
...
* **[SeqFu](https://github.com/telatin/seqfu2) ⭐ 131 | 🐛 0 | 🌐 Nim | 📅 2026-09-24** - Sequence manipulation toolkit for FASTA/FASTQ files written in Nim. \[ [paper-2021](https://www.mdpi.com/2306-5354/8/5/59) | [web](https://telatin.github.io/seqfu2/) ]
...
* **[Hail](https://github.com/hail-is/hail) ⭐ 1,076 | 🐛 367 | 🌐 Python | 📅 2026-09-24** - Scalable genomic analysis.
...
* **[DeepVariant](https://github.com/google/deepvariant) ⭐ 3,810 | 🐛 3 | 🌐 Python | 📅 2026-09-24** - Deep learning-based variant caller \[ [paper-2018](https://rdcu.be/7Dhl) ]
* **[bcftools](https://github.com/samtools/bcftools) ⭐ 894 | 🐛 347 | 🌐 C | 📅 2026-09-21** - samtools/bcftools are a suite of tools for manipulating NGS data and can be used to call variants. \[ [paper-2009](https://pubmed.ncbi.nlm.nih.gov/19505943) | [web](http://htslib.org) ]
...
* **[Delly](https://github.com/dellytools/delly) ⭐ 537 | 🐛 38 | 🌐 C++ | 📅 2026-09-24** - Structural variant discovery by integrated paired-end and split-read analysis. \[ [paper-2012](https://pubmed.ncbi.nlm.nih.gov/22962449) ]
...
* **[Somalier](https://github.com/brentp/somalier) ⭐ 336 | 🐛 62 | 🌐 Nim | 📅 2026-09-24** - Fast sample-swap and relatedness checks on BAMs/CRAMs/VCFs/GVCFs. \[ [paper-2020](https://pubmed.ncbi.nlm.nih.gov/32664994) ]
...
* **[bcftools](https://github.com/samtools/bcftools) ⭐ 894 | 🐛 347 | 🌐 C | 📅 2026-09-21** - Set of tools for manipulating VCF files. \[ [paper-2016](https://pubmed.ncbi.nlm.nih.gov/26826718) | [paper-2017](https://pubmed.ncbi.nlm.nih.gov/28205675) | [web](http://samtools.github.io/bcftools) ]
...
* **[pyensembl](https://github.com/openvax/pyensembl) ⭐ 409 | 🐛 12 | 🌐 Python | 📅 2026-09-24** - Pythonic Access to the Ensembl database. \[ [web](https://pyensembl.readthedocs.io/en/latest/pyensembl.html) ]
...
* **[Scanpy](https://github.com/scverse/scanpy) ⭐ 2,566 | 🐛 539 | 🌐 Python | 📅 2026-09-24** - Scalable toolkit for analyzing single-cell gene expression data, including preprocessing, visualization, clustering, and trajectory inference. \[ [paper-2018](https://doi.org/10.1186/s13059-017-1382-0) | [web](https://scanpy.readthedocs.io) ]
